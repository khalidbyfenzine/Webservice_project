...
public class ObjectFactory {
    ...
    private final static QName _ConversionEuroToMadResponse_QNAME = new QName("http://ws/", "ConversionEuroToMadResponse");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws/", "getCompteResponse");
    private final static QName _ConversionEuroToMad_QNAME = new QName("http://ws/", "ConversionEuroToMad");
    ...
    public JAXBElement<ConversionEuroToMadResponse> createConversionEuroToMadResponse(ConversionEuroToMadResponse value) {
        return new JAXBElement<ConversionEuroToMadResponse>(_ConversionEuroToMadResponse_QNAME, ConversionEuroToMadResponse.class, null, value);
    }
    ...
    public JAXBElement<ConversionEuroToMad> createConversionEuroToMad(ConversionEuroToMad value) {
        return new JAXBElement<ConversionEuroToMad>(_ConversionEuroToMad_QNAME, ConversionEuroToMad.class, null, value);
    }
